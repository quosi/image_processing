...
INPUTPATH = '/home/pepper/Projects/spiced/final_project/images/videos_errors/D84_h264_errors_px_bl_bl-ed.mp4' # for flask use 'uploads/'
FIX_IMG_SQR_SIZE = 64
...
def video_process(threshold=THRESHOLD, inputpath=INPUTPATH):
    ...
    name = inputpath.split('/')[-1].split('.')[0]
    print(name)
    i=0
    ...
    while(cap.isOpened()):
        ...
        if ret == True:
            ...
            frame_sqrs_list.append(squares_list)
            Image.fromarray(frame).save(f"/home/pepper/Projects/spiced/final_project/flask_app/frames/{name}_{i}.png")
